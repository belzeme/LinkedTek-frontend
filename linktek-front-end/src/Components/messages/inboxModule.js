        ...
        <div style={{maxHeight: 600, overflow: 'auto', marginTop: 20}}>
          <List dense className={classes.root}>
            {this.props.messages.map((value, index) => (
              <Paper key={index} style={{maxWidth: 720, minWidth: 720, marginBottom: 50}}>
                <ListItem key={value}>
                  <div>
                ...
                <Grid container spacing={24} style={{marginLeft: "auto", marginRight: "auto"}}>
                  <Grid item xs>
                    <Button variant="outlined" color="default" className={classes.button} onClick={this.props.handleDeleteMessageModalShow}>
                      Delete
                      <DeleteIcon className={classes.rightIcon} style={{marginLeft: 5}}/>
                    </Button>
